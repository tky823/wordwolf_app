...
class PlayerBulletinRoomPage extends StatefulWidget {
  final String roomId;
  final Map<String, String> themes;
  PlayerBulletinRoomPage({this.roomId, this.themes});

  @override
  State<StatefulWidget> createState() => _PlayerBulletinRoomPageState();
}

class _PlayerBulletinRoomPageState extends State<PlayerBulletinRoomPage> {
